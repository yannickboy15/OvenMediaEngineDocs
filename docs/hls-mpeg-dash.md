...
* `http://[OvenMediaEngine IP]:80/app/<stream name>_o/manifest_ll.mpd`
 ...
 is the name of the input stream sent by the encoder and &lt;stream name&gt;\_o is the transcoded output stream. If you want to play the output bypassing the transcoding, you can play it like this: This is the default configuration, and you can modify these settings yourself by editing Server.xml.

* `https://[OvenMediaEngine IP]:80/app/<stream name>_bypass/playlist.m3u8`
* `http://[OvenMediaEngine IP]:80/app/<stream name>_bypass/playlist.m3u8`
* `https://[OvenMediaEngine IP]:80/app/<stream name>_bypass/manifest.mpd`
* `http://[OvenMediaEngine IP]:80/app/<stream name>_bypass/manifest.mpd`
* `https://[OvenMediaEngine IP]:80/app/<stream name>_bypass/manifest_ll.mpd`
* `http://[OvenMediaEngine IP]:80/app/<stream name>_bypass/manifest_ll.mpd`
