...
```bash
(curl -LOJ https://github.com/AirenSoft/OvenMediaEngine/archive/v0.10.5.tar.gz && tar xvfz OvenMediaEngine-0.10.5.tar.gz)
OvenMediaEngine-0.10.5/misc/prerequisites.sh
```
