...
airensoft/ovenmediaengine:0.12.0
```
...
```bash
(curl -LOJ https://github.com/AirenSoft/OvenMediaEngine/archive/v0.12.0.tar.gz && tar xvfz OvenMediaEngine-0.12.0.tar.gz)
OvenMediaEngine-0.12.0/misc/prerequisites.sh
```
