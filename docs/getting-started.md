...
```bash
(curl -LOJ https://github.com/AirenSoft/OvenMediaEngine/archive/v0.10.3.tar.gz && tar xvfz OvenMediaEngine-0.10.3.tar.gz)
OvenMediaEngine-0.10.3/misc/prerequisites.sh
```
