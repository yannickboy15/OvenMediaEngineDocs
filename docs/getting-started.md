...
airensoft/ovenmediaengine:0.12.5
```
...
```bash
(curl -LOJ https://github.com/AirenSoft/OvenMediaEngine/archive/v0.12.5.tar.gz && tar xvfz OvenMediaEngine-0.12.5.tar.gz)
OvenMediaEngine-0.12.5/misc/prerequisites.sh
```
