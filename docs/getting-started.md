...
| OME\_ICE\_CANDIDATES | \*:10000-10010/udp |
...
```bash
(curl -LOJ https://github.com/AirenSoft/OvenMediaEngine/archive/v0.10.9.tar.gz && tar xvfz OvenMediaEngine-0.10.9.tar.gz)
OvenMediaEngine-0.10.9/misc/prerequisites.sh
```
