...
```bash
(curl -LOJ https://github.com/AirenSoft/OvenMediaEngine/archive/v0.11.0.tar.gz && tar xvfz OvenMediaEngine-0.11.0.tar.gz)
OvenMediaEngine-0.11.0/misc/prerequisites.sh
```
