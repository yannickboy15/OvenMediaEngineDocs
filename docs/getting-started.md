...
airensoft/ovenmediaengine:0.11.3
```
...
```bash
(curl -LOJ https://github.com/AirenSoft/OvenMediaEngine/archive/v0.11.3.tar.gz && tar xvfz OvenMediaEngine-0.11.3.tar.gz)
OvenMediaEngine-0.11.3/misc/prerequisites.sh
```
